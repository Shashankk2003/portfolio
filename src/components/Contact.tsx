...
function Field({
  ...
  return (
    <div className="flex flex-col gap-1.5">
      ...
      <div className={`rounded-xl transition-all duration-200 ${focused ? "ring-2 ring-primary/40" : "ring-1 ring-white/8"} ${error ? "ring-red-500/50" : ""}`}>
        {multiline ? (
          <textarea
            id={id}
            rows={5}
            ...
            className="w-full bg-white/[0.04] rounded-xl px-4 py-3.5 text-white text-sm font-normal placeholder-white/20 outline-none resize-none"
          ...
          <input
            ...
            onFocus={() => setFocused(true)}
            onBlur={() => setFocused(false)}
            className="w-full bg-white/[0.04] rounded-xl px-4 h-12 text-white text-sm font-normal placeholder-white/20 outline-none"
            placeholder={`Enter ${label.toLowerCase()}...`}
            {...(register as object)}
          />
        )}
...
export function Contact() {
  ...
  return (
    <section id="contact" className="py-[120px] bg-[#0A0A0A] relative z-10 overflow-hidden" ref={sectionRef}>
      ...
      <div className="container mx-auto px-6 max-w-3xl">
        ...
        >
          <div className="rounded-[2rem] bg-[#111] border border-white/5 p-8 md:p-10 relative overflow-hidden">
              ...
              {submitted ? (
                ...
                >
                  ...
                  <motion.button
                    ...
                    className="w-full h-14 rounded-xl bg-primary text-white text-sm uppercase tracking-widest font-bold flex items-center justify-center gap-3 shadow-lg shadow-primary/25 hover:bg-primary/90 transition-colors disabled:opacity-60 disabled:cursor-not-allowed mt-1"
                  >
                    {submitting ? (
